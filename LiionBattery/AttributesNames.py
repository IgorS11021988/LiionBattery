...
UParametersSystemParametersNames = ["I",  # Ток во внешней цепи, А
                                    "IStep",  # Ток разряда после ступеньки, А
...
otherSystemParametersNames = ["UChMax",  # Граничное напряжение заряда, В
                              "bI0Ch",  # Граница зарядного нулевого тока, А
                              ...
                              "eQIn",  # Интенсивность подвода дополнительной внешней теплоты к внутреннему содержимому аккумулятора, Вт
                              "eQB",  # Интенсивность подвода дополнительной внешней теплоты к корпусу аккумулятора, Вт
...
processCoordinatesNames = ["dqbinp",  # Ток через положительный двойной слой
                           ...
                           "deactp",  # Деактивация положительного электрода
                           "deactn",  # Деактивация отрицательного электрода
                           "degp",  # Деградация положительного электрода по циклированию
                           "degn",  # Деградация отрицательного электрода по циклированию
                           "dqDegPosEl"  # Деградация положительного электрода по переразряду
                           ]
