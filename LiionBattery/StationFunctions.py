...
def funRQ(nRQ, Cnom, dissU, alphaRQ, rNuLi0, nuLi):  # Мультипликативная корректировка по заряду через внешнюю цепь
...
def funRbin(alphaRIp, alphaRIn, dissUbinp, dissUbinn,
    ...
    rQbinp = funRQ(nRQp, Cnom, dissUbinp, alphaRQp, rNuLi0p, nuLip)  # Положительный двойной слой
    rQbinn = funRQ(nRQn, Cnom, dissUbinn, alphaRQn, 0.0, nuLin)  # Отрицательный двойной слой
